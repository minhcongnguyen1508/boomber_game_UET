...
public class Board implements IRender {
	...
	public Entity getEntity(double x, double y, Character m) {
        ...
        public Entity getEntityGrass(double x, double y){
            Entity res = null;
            res = getFlameSegmentAt((int)x, (int)y);
            if( res != null) return res;
            res = getBombAt(x, y);
	...
	public Character getCharcterAt(double x, double y) {
	...
	public Portal getPortal(){
			...
			if(_entities[i] instanceof Portal)
				return (Portal)_entities[i];
		}
		return null;		
        }
