...
public class Sprite {
	...
	|--------------------------------------------------------------------------
	 */
	public static Sprite player1_up = new Sprite(16, 0, 12, SpriteSheet.tiles, 12, 16);
	public static Sprite player1_down = new Sprite(16, 2, 12, SpriteSheet.tiles, 12, 15);
	public static Sprite player1_left = new Sprite(16, 3, 12, SpriteSheet.tiles, 10, 15);
	public static Sprite player1_right = new Sprite(16, 1, 12, SpriteSheet.tiles, 10, 16);
	
	public static Sprite player1_up_1 = new Sprite(16, 0, 13, SpriteSheet.tiles, 12, 16);
	public static Sprite player1_up_2 = new Sprite(16, 0, 14, SpriteSheet.tiles, 12, 15);
	
	public static Sprite player1_down_1 = new Sprite(16, 2, 13, SpriteSheet.tiles, 12, 15);
	public static Sprite player1_down_2 = new Sprite(16, 2, 14, SpriteSheet.tiles, 12, 16);
	
	public static Sprite player1_left_1 = new Sprite(16, 3, 13, SpriteSheet.tiles, 11, 16);
	public static Sprite player1_left_2 = new Sprite(16, 3, 14, SpriteSheet.tiles, 12 ,16);
	
	public static Sprite player1_right_1 = new Sprite(16, 1, 13, SpriteSheet.tiles, 11, 16);
	public static Sprite player1_right_2 = new Sprite(16, 1, 14, SpriteSheet.tiles, 12, 16);
	
	public static Sprite player1_dead1 = new Sprite(16, 4, 2, SpriteSheet.tiles, 14, 16);
	public static Sprite player1_dead2 = new Sprite(16, 5, 2, SpriteSheet.tiles, 13, 15);
	public static Sprite player1_dead3 = new Sprite(16, 6, 2, SpriteSheet.tiles, 16, 16);
	...
	//ONEAL
	public static Sprite oneal_left1 = new Sprite(16, 12, 0, SpriteSheet.tiles, 16, 16);
	public static Sprite oneal_left2 = new Sprite(16, 12, 1, SpriteSheet.tiles, 16, 16);
	public static Sprite oneal_left3 = new Sprite(16, 12, 2, SpriteSheet.tiles, 16, 16);
	...
	//Minvo
	public static Sprite minvo_left1 = new Sprite(16, 6, 5, SpriteSheet.tiles, 16, 16);
	public static Sprite minvo_left2 = new Sprite(16, 6, 6, SpriteSheet.tiles, 16, 16);
	public static Sprite minvo_left3 = new Sprite(16, 6, 7, SpriteSheet.tiles, 16, 16);
	
	public static Sprite minvo_right1 = new Sprite(16, 6, 5, SpriteSheet.tiles, 16, 16);
	public static Sprite minvo_right2 = new Sprite(16, 6, 6, SpriteSheet.tiles, 16, 16);
	public static Sprite minvo_right3 = new Sprite(16, 6, 7, SpriteSheet.tiles, 16, 16);
	
	public static Sprite minvo_dead = new Sprite(16, 6, 6, SpriteSheet.tiles, 16, 16);
